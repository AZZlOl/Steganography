        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="card" style="width: 750px; inline-block; margin-right: 100px;">
                <form action="deliver.php" method="post" enctype='multipart/form-data'>
                    <div class="card-header"><h1>Upload an Image to Decode</h1></div>
                    <div class="card-body">
                    ...
                    <div class="card-footer text-right"><input type="submit" name='decode' value='Decode' class='btn btn-primary' onclick=""></div>
